...
interface NavBarOption {
  ...
  iconButtonActive: ReactElement
  textButton: string
}

export const optionNavBar: NavBarOption[] = [
  {
    pathName: '/home',
    iconButton: (
      <svg
  ...
  },
  {
    ...
    iconButtonActive: (
      <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='currentColor' className='h-7'>
        <path
          fillRule='evenodd'
